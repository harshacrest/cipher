"""VWAP SD Straddles V2 backtest runner — entry on 1SD crossdown, SL = VAL + 500."""
...
from strategies.vwap_sd_straddles_v2 import VWAPSDStraddlesV2, VWAPSDStraddlesV2Config
...
def run_single_day_engine(date_str: str, base_config_kwargs: dict) -> list[dict]:
    ...
    config = VWAPSDStraddlesV2Config(**base_config_kwargs)
    strategy = VWAPSDStraddlesV2(config=config)
...
def run_backtest(
    strategy_name: str = "vwap_sd_straddles_v2",
...
def main():
    strategy_name = "vwap_sd_straddles_v2"
